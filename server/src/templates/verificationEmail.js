/**
 * Clean, modern, minimalist HTML email template for Account Verification OTP
 * @param {object} params
 * @param {string} params.displayName - Recipient's display name
 * @param {string} params.otp - 6-digit OTP code
 * @returns {string} HTML email string
 */
export const getVerificationEmail = ({ displayName, otp }) => {
  return `<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  <title>Verify your email - NexChat</title>
</head>
          ...
          <tr>
            <td style="padding: 32px 32px 24px 32px;">
              ...
              <p style="margin: 0 0 24px 0; font-size: 15px; color: #475569; line-height: 1.6;">
                Hi <strong style="color: #0f172a;">${displayName || 'there'}</strong>, thanks for joining NexChat. Use the 6-digit code below to complete your registration:
              </p>
